  ...
  return (
    <section className="flex justify-center w-md m-auto">
      <div className="w-full rounded-2xl border border-white/8 bg-surface/90 sm:p-8">
        ...
        <button
          type="button"
          className="mt-2 flex w-full items-center justify-center gap-3 rounded-xl border border-white/6 bg-secondary/90 px-4 py-3 text-sm font-semibold text-foreground transition hover:bg-secondary"
        >
          <GoogleIcon />
          Continue with Google
        </button>

        <div className="my-4 flex items-center gap-3 text-[11px] uppercase tracking-[0.24em] text-sky-100/35">
        ...
        <form className="space-y-5">
          ...
          <button
            type="submit"
            className="w-full rounded-xl bg-primary px-4 py-3 text-sm font-semibold text-primary-foreground shadow-[0_16px_40px_rgba(19,127,236,0.35)] transition hover:bg-blue-500"
          >
            Sign Up
          </button>
        </form>
